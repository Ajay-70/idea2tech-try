...
function AboutUs() {
  return (
    <div>
      ...
      {/* try 1 */}
      <div className="flex h-screen justify-center items-center max-w-screen-xl mx-auto">
        <div className="sm:w-1/2 p-10">
          <div className="max-w-2xl mx-auto">
            ...
            >
              {/* <!-- Carousel wrapper --> */}
              <div className="relative h-150 md:h-96" data-carousel-inner>
                {/* <!-- Item 1 --> */}
                <div
        ...
        <div className="sm:w-1/2 p-5">
          <div className="text">
            <span className="text-gray-500 bold  border-b-2 border-indigo-600 uppercase">
              Welcome !
            </span>
            <h2 className="my-4 font-bold text-3xl sm:text-4xl">
              <span className="text-indigo-600">At Idea2Tech</span>
            </h2>
